defmodule JobBoardWeb.Router do
  ...
  import JobBoardWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {JobBoardWeb.Layouts, :root}
  ...
  scope "/", JobBoardWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{JobBoardWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", JobBoardWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{JobBoardWeb.UserAuth, :ensure_authenticated}] do
